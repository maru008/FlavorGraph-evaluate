...
enbd_data_ls = ['Metapath2vec+CSP.pickle',
                'Metapath2vec+HiddenFP.pickle','Metapath2vec+Morgan2binary.pickle','Metapath2vec+PubchemFP_W2V.pickle','Metapath2vec+M2Vtrain.pickle','Metapath2vec+M2Vtrain_100.pickle']
