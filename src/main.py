...
enbd_data_ls = ['Metapath2vec.pickle','Metapath2vec+NPMI.pickle','Metapath2vec+CSP.pickle','Metapath2vec+HiddenFP.pickle',
                'Metapath2vec+M2Vtrain.pickle',
                'Metapath2vec+NPMI+CSP.pickle','Metapath2vec+NPMI+M2Vtrain.pickle']
